(()=>{
  ...
  async function busy(button,task){button.disabled=true;try{await task()}catch(e){fail(e)}finally{button.disabled=button.dataset.done==="true"}}
