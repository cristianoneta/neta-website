(()=>{
  ...
  const CHECKPOINT={mockCodeId:109,socialsCodeId:110};
  ...
  const state={client:null,address:null,mock:null,socials:null,mockCodeId:CHECKPOINT.mockCodeId,socialsCodeId:CHECKPOINT.socialsCodeId};
