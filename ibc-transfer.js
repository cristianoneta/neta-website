(()=>{
  ...
  function rawAmount(value){if(!/^(?:0|[1-9]\d*)(?:\.\d{0,6})?$/.test(value))return null;const [whole,fraction=""]=value.split(".");return BigInt(whole)*1000000n+BigInt((fraction+"000000").slice(0,6))}
